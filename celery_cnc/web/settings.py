...
CELERY_CNC_MCP_ENABLED = CONFIG.mcp_enabled
CELERY_CNC_MCP_HOST = CONFIG.mcp_host
CELERY_CNC_MCP_PORT = CONFIG.mcp_port
CELERY_CNC_MCP_PATH = CONFIG.mcp_path
CELERY_CNC_MCP_AUTH_KEY_SET = bool(CONFIG.mcp_auth_key)
