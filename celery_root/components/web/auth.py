...
_SESSION_AUTH_KEY = "celery_root_auth"
_SESSION_STATE_KEY = "celery_root_oauth_state"
_SESSION_NEXT_KEY = "celery_root_oauth_next"
...
def load_auth_config() -> AuthConfig:
    ...
    raw_basic = _get_setting(
        "CELERY_ROOT_BASIC_AUTH",
        ("FLOWER_BASIC_AUTH", "FLOWER_BASIC_AUTHENTICATION", "FLOWER_BASIC_AUTHORIZATION"),
    )
    raw_provider = _get_setting("CELERY_ROOT_AUTH_PROVIDER", ("FLOWER_AUTH_PROVIDER",))
    raw_auth = _get_setting("CELERY_ROOT_AUTH", ("FLOWER_AUTH",))
    oauth2_key = _get_setting("CELERY_ROOT_OAUTH2_KEY", ("FLOWER_OAUTH2_KEY",))
    oauth2_secret = _get_setting("CELERY_ROOT_OAUTH2_SECRET", ("FLOWER_OAUTH2_SECRET",))
    oauth2_redirect = _get_setting("CELERY_ROOT_OAUTH2_REDIRECT_URI", ("FLOWER_OAUTH2_REDIRECT_URI",))
